...
<body>
  <div class="app-container">
    ...
    <footer class="footer">Área27 Sinuca &bull; ESP8266 Edition v2.0.3</footer>
  </div>
  ...
  <div class="app-container">
    ...
    <main>
      <div class="card" style="text-align: center; padding: 24px 20px;">
        ...
        <p style="color: var(--gold); font-weight: 700; font-size: 1.1rem; margin-bottom: 20px;">Versão v2.0.3</p>
        ...
        <div style="background: #161616; border: 1px solid var(--border-color); border-radius: var(--radius-sm); padding: 16px; margin-bottom: 20px; text-align: left; display: flex; flex-direction: column; gap: 10px; font-size: 0.92rem;">
          <div><strong style="color: var(--text-muted);">Versão Instalada:</strong> <span style="color: var(--gold); font-weight:700;">v2.0.3</span></div>
